...
{
    public class GameVictoryScreen : ScreenBase
    {
        public GameVictoryScreen(Storage storage)
        {
            Storage = storage;
        }

        public Storage Storage { get; }
        public GameVictoryLayout Layout { get; set; }
        ...
        public override void Setup()
        {
            ...
            // create the layout
            Layout = new GameVictoryLayout(Storage);
        }
